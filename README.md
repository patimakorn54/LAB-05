...
จากผลการทดลองพบว่า แสดงผล 3 and 6 เนื่อง จากคำสั่ง {0} and {1}

![](https://github.com/patimakorn54/LAB-05/blob/master/img/Capture2.JPG?raw=true)


###คำถาม 5.1 เครื่องหมาย { }  ในคำสั่ง Console.WriteLine() มีลักษณะการใช้งานอย่างไร


เป็นคำสั่ง ที่ใช้โดยใส่ฟังก์ชั่นการแสดงผลเข้าไปใน ()


###คำถาม 5.2  ถ้ามีการใช้ตัวเลขใน { } ที่กระโดด เช่น {0} {2} {3} จะใช้งานได้หรือไม่ อย่างไร จงอธิบาย


สามารถใช้งานได้ เพราะว่า {0} {2} {3} แต่จะไม่ดึงตัวที่1 ออกมาก
